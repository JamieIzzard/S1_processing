...
directory = '/geog/data/whale/alpha/jizzard/S1/AntPen/pairs/'
os.chdir(directory)
counter = 0

for pair in os.listdir('.'):
    if len(os.listdir(pair)) == 2:
        counter += 1
        if counter == 10:
            while True:
                try:
                    proceed = str(input('20 pairs computed, Check all is OK. Do you Wish to proceed? (y or n): '))
                except ValueError:
        ...
        dem_par_name = '/geog/data/whale/alpha/jizzard/dems/bond/bond_100_combined.dem_par' #'/geog/data/whale/alpha/jizzard/dems/ferrigno_100.dem_par'
        dem_name =    '/geog/data/whale/alpha/jizzard/dems/bond/bond_combined.dem'              #'/geog/data/whale/alpha/jizzard/dems/ferrigno_100.dem'
        dem_seg_par =  dem_name             #'/geog/data/whale/alpha/jizzard/dems/ferrigno_100.dem_seg_par'
        ...
        '''
        pixels=1317 This is Now in Filtering
        ...
        #Remove coregistration Lookup table
        os.remove(lut)
        #Remove original SLC files.
        #os.remove(b_slc)
        os.remove(coreg_slc)
        #os.remove(coreg_slc_par)
